...
const struct flash_device flash_devices[] = {
	...
	FLASH_ID("issi is25lq040",      0x03, 0x6b, 0x02, 0xd7, 0xc7, 0x0013409d, 0x100, 0x1000, 0x80000,      &issi_ops),
	...
	// Doesn't support sst25vf016b
	// FLASH_ID("microchip sst25vf016b",     0x03, 0x00, 0xad, 0x20, 0xc7, 0x004125bf, 0x100, 0x1000, 0x200000,  NULL),
	
	// FLASH_ID("win w25q01jv",        0x03, 0x6b, 0x02, 0x20, 0xc7, 0x002140ef, 0x100, 0x10000, 0x8000000,     &win_ops),
	...
	FLASH_ID("sp s25fl256s",        0x13, 0x00, 0x12, 0xd8, 0xc7, 0x00190201, 0x100, 0x10000, 0x2000000,     &sp_s25fl_ops),
	...
	FLASH_ID("micron n25q128 1.8v", 0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x0018ba20, 0x100, 0x10000, 0x1000000,     &micron_n25q_ops),
	...
	FLASH_ID("win w25q16jv",        0x03, 0x00, 0x02, 0xd8, 0xc7, 0x001570ef, 0x100, 0x10000, 0x200000,     &win_ops), /* QPI / DTR */
	FLASH_ID("win w25q32fv/jv",     0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001640ef, 0x100, 0x10000, 0x400000,     &win_ops),
	FLASH_ID("win w25q32fv",        0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001660ef, 0x100, 0x10000, 0x400000,     &win_ops), /* QPI mode */
	FLASH_ID("win w25q32jv",        0x03, 0x00, 0x02, 0xd8, 0xc7, 0x001670ef, 0x100, 0x10000, 0x400000,     &win_ops),
	FLASH_ID("win w25q64fv/jv",     0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001740ef, 0x100, 0x10000, 0x800000,     &win_ops),
	FLASH_ID("win w25q64fv",        0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001760ef, 0x100, 0x10000, 0x800000,     &win_ops), /* QPI mode */
	...
	FLASH_ID("win w25q128fv",       0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001860ef, 0x100, 0x10000, 0x1000000,     &win_ops), /* QPI mode */
	...
	FLASH_ID("win w25q256fv",       0x03, 0xeb, 0x02, 0xd8, 0xc7, 0x001960ef, 0x100, 0x10000, 0x2000000,     &win_ops), /* QPI mode */
	...
	FLASH_ID("gd gd25q256c",        0x13, 0x00, 0x12, 0xd8, 0xc7, 0x001940c8, 0x100, 0x10000, 0x2000000,     &gd_gd25q_ops),
	...
	FLASH_ID("issi is25lp256d",     0x13, 0xec, 0x12, 0xd8, 0xc7, 0x0019609d, 0x100, 0x10000, 0x2000000,     &issi_ops),
	FLASH_ID("issi is25wp256d",     0x13, 0xec, 0x12, 0xd8, 0xc7, 0x0019709d, 0x100, 0x10000, 0x2000000,     &issi_ops),
