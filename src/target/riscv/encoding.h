...
#define CSR_SPMPADDRA 0x1ba
#define CSR_SPMPADDRB 0x1bb
#define CSR_SPMPADDRC 0x1bc
#define CSR_SPMPADDRD 0x1bd
#define CSR_SPMPADDRE 0x1be
#define CSR_SPMPADDRF 0x1bf
...
DECLARE_CSR(spmpaddra, CSR_SPMPADDRA)
DECLARE_CSR(spmpaddrb, CSR_SPMPADDRB)
DECLARE_CSR(spmpaddrc, CSR_SPMPADDRC)
DECLARE_CSR(spmpaddrd, CSR_SPMPADDRD)
DECLARE_CSR(spmpaddre, CSR_SPMPADDRE)
DECLARE_CSR(spmpaddrf, CSR_SPMPADDRF)
DECLARE_CSR(mcountinhibit, CSR_MCOUNTINHIBIT)
...
DECLARE_CSR(mdevb, CSR_MDEVB)
DECLARE_CSR(mdevm, CSR_MDEVM)
DECLARE_CSR(mnocb, CSR_MNOCB)
DECLARE_CSR(mnocm, CSR_MNOCM)
DECLARE_CSR(msmpcfg_info, CSR_MSMPCFG_INFO)
