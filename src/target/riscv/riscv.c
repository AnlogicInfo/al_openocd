	...
	void *arch_info)
{
	...
	current_mstatus=algorithm_info->mstatus; //TODO figure out what the fuck is happening here
	...
	return riscv_resume(target, 0, entry_point, 0, 0, true);
}
	...
	void *arch_info)
{
	...
	/* Restore registers */
	uint8_t buf[8] = { 0 };
	buf_set_u64(buf, 0, info->xlen, algorithm_info->saved_pc);
